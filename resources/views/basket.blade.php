                ...
                <tr>
                    <td>
                        <a href="http://internet-shop.tmweb.ru/appliances/delongi">
                            <img height="56px" src="http://internet-shop.tmweb.ru/storage/products/delongi.jpg">
                            Кофемашина DeLongi
                        </a>
                    </td>
                    <td><span class="badge">1</span>
                        <div class="btn-group form-inline">
                            <form action="http://internet-shop.tmweb.ru/basket/remove/8" method="POST">
                                <button type="submit" class="btn btn-danger" href=""><span
                                        class="glyphicon glyphicon-minus" aria-hidden="true"></span></button>
                                <input type="hidden" name="_token" value="Td2PrbGiC2BB1mnYutwrc8ZPfLdt6MsPDnAIcBN8">                            </form>
